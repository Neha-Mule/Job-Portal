...
<body>
    ...
    <nav class="navbar bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="\php\admin_main.php">

                RecruitYes
            </a>
            <form action="\php\admin_main.php" class="d-flex">
    ...
    if($portal!=0)
    {
      ...
      {
        echo '<div class="card1 offset-2 col-7 my-3">
        <div class="card">
            <h5 class="card-header">Firstname: '.$result['fname'].'  '.$result['lname'].'</h5>
            <div class="card-body">
              ...
              <p class="card-text">10th marks: '.$result['tenth'].'</p>
              <p class="card-text">12th marks: '.$result['twelth'].'</p>
              <p class="card-text">College: '.$result['College'].'</p>
              <p class="card-text">Branch: '.$result['Branch'].'</p>
              <p class="card-text">Skills: '.$result['skills'].'</p>
              <p class="card-text">Projects: '.$result['Projects'].'</p>
              <p class="card-text">city: '.$result['city'].'</p>
              <p class="card-text">state: '.$result['state'].'</p>
              <p class="card-text">zip: '.$result['zip'].'</p>
