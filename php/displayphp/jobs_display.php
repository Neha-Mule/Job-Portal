    ...
    if($portal!=0)
    {
      ...
      while($result=mysqli_fetch_assoc($data))
      {
        ...
        <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">'.$result['loc'].'</h5>
              <p class="card-text">'.$result['desci'].'</p>
              <p class="card-text">'.$result['mode'].'</p>
              <a href="/frontednd/apply.html" class="btn btn-primary offset-9 col-1">Apply</a>
            </div>
          </div>
        </div>';
      }
